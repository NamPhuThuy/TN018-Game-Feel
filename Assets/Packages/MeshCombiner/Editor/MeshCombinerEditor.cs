...
public class MeshCombinerEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        #region filteredMeshFilters array:
        SerializedProperty filteredMeshFilters = serializedObject.FindProperty("filteredMeshFilters");
        EditorGUI.BeginChangeCheck();
        EditorGUILayout.PropertyField(filteredMeshFilters, true);
        if (EditorGUI.EndChangeCheck())
        {
            serializedObject.ApplyModifiedProperties();
        }
        #endregion filteredMeshFilters array.
        ...
        {
            meshCombiner.DisableMeshFilter(true);
        }
